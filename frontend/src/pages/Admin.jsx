                              ...
                              {students.slice(0, 5).map(s => (
                                 <div key={s._id} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "15px", background: "#fdfdfd", border: "1.5px solid #f5f5f5", borderRadius: "16px", transition: "0.3s" }}>
                                    ...
                                    <div style={{ textAlign: "right" }}>
                                       <div style={{ fontSize: "12px", fontWeight: 900, color: s.atsScore > 75 ? "#22c55e" : "#10b981" }}>{s.atsScore}% Score</div>
                        ...
                        <div className="admin-card dark-card">
                           ...
                           <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
                              {[
                                 ...
                                 <div key={i} style={{ fontSize: "13px", fontWeight: 700, display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px", background: "rgba(11, 10, 10, 0.91)", borderRadius: "10px" }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
